...
public class ReservationAdminController {
    ...
    @GetMapping("/all")
    public ResponseEntity<ReservationDTO> getAll(){
        try {
    ...
    public ResponseEntity<TakeReservationDTO> addClientToReservation(@PathVariable Long reservationId,@RequestBody TakeReservationDTO reservation1){
       return new ResponseEntity<>(reservationService.updateReservation(reservationId,reservation1),org.springframework.http.HttpStatus.OK);
    }
