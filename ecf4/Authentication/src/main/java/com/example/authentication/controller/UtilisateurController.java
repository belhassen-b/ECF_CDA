...
public class UtilisateurController {
    ...
    @GetMapping("user")
    public ResponseEntity<Utilisateur> getUserInfo(Principal principal) {
    Optional<Utilisateur> utilisateur = utilisateurService.trouverParUsername(principal.getName());
